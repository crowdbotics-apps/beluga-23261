...
export const api_v1_events_list = () => ({ type: types.API_V1_EVENTS_LIST })
export const api_v1_events_listSucceeded = (response, starter) => ({
  type: types.API_V1_EVENTS_LIST_SUCCEEDED,
  response,
  starter
})
export const api_v1_events_listFailed = (error, starter) => ({
  type: types.API_V1_EVENTS_LIST_FAILED,
  error,
  starter
})
export const api_v1_events_create = data => ({
  type: types.API_V1_EVENTS_CREATE,
  data
})
export const api_v1_events_createSucceeded = (response, starter) => ({
  type: types.API_V1_EVENTS_CREATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_events_createFailed = (error, starter) => ({
  type: types.API_V1_EVENTS_CREATE_FAILED,
  error,
  starter
})
export const api_v1_events_read = () => ({ type: types.API_V1_EVENTS_READ })
export const api_v1_events_readSucceeded = (response, starter) => ({
  type: types.API_V1_EVENTS_READ_SUCCEEDED,
  response,
  starter
})
export const api_v1_events_readFailed = (error, starter) => ({
  type: types.API_V1_EVENTS_READ_FAILED,
  error,
  starter
})
export const api_v1_events_update = data => ({
  type: types.API_V1_EVENTS_UPDATE,
  data
})
export const api_v1_events_updateSucceeded = (response, starter) => ({
  type: types.API_V1_EVENTS_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_events_updateFailed = (error, starter) => ({
  type: types.API_V1_EVENTS_UPDATE_FAILED,
  error,
  starter
})
export const api_v1_events_partial_update = data => ({
  type: types.API_V1_EVENTS_PARTIAL_UPDATE,
  data
})
export const api_v1_events_partial_updateSucceeded = (response, starter) => ({
  type: types.API_V1_EVENTS_PARTIAL_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_events_partial_updateFailed = (error, starter) => ({
  type: types.API_V1_EVENTS_PARTIAL_UPDATE_FAILED,
  error,
  starter
})
export const api_v1_events_delete = () => ({ type: types.API_V1_EVENTS_DELETE })
export const api_v1_events_deleteSucceeded = (response, starter) => ({
  type: types.API_V1_EVENTS_DELETE_SUCCEEDED,
  response,
  starter
})
export const api_v1_events_deleteFailed = (error, starter) => ({
  type: types.API_V1_EVENTS_DELETE_FAILED,
  error,
  starter
})
