  ...
  switch (action.type) {
    ...
    case types.API_V1_CUSTOMTEXT_LIST_FAILED:
      return Object.assign({}, state, {
        belugaAPI: [...state.belugaAPI, action.response]
      })
    ...
    case types.API_V1_EVENTS_LIST:
    case types.API_V1_EVENTS_LIST_SUCCEEDED:
    case types.API_V1_EVENTS_LIST_FAILED:
      return Object.assign({}, state, {
        belugaAPI: [...state.belugaAPI, action.response]
      })
    case types.API_V1_EVENTS_CREATE:
    case types.API_V1_EVENTS_CREATE_SUCCEEDED:
    case types.API_V1_EVENTS_CREATE_FAILED:
      return Object.assign({}, state, {
        belugaAPI: [...state.belugaAPI, action.response]
      })
    case types.API_V1_EVENTS_READ:
    case types.API_V1_EVENTS_READ_SUCCEEDED:
    case types.API_V1_EVENTS_READ_FAILED:
      return Object.assign({}, state, {
        belugaAPI: [...state.belugaAPI, action.response]
      })
    case types.API_V1_EVENTS_UPDATE:
    case types.API_V1_EVENTS_UPDATE_SUCCEEDED:
    case types.API_V1_EVENTS_UPDATE_FAILED:
      return Object.assign({}, state, {
        belugaAPI: [...state.belugaAPI, action.response]
      })
    case types.API_V1_EVENTS_PARTIAL_UPDATE:
    case types.API_V1_EVENTS_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_EVENTS_PARTIAL_UPDATE_FAILED:
      return Object.assign({}, state, {
        belugaAPI: [...state.belugaAPI, action.response]
      })
    case types.API_V1_EVENTS_DELETE:
    case types.API_V1_EVENTS_DELETE_SUCCEEDED:
    case types.API_V1_EVENTS_DELETE_FAILED:
      return Object.assign({}, state, {
        belugaAPI: [...state.belugaAPI, action.response]
      })
